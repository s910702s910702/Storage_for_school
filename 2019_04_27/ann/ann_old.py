...
def Backpropagation(input_x, input_y, ni, nh, no, lr):
	...
	for i in range(max_epoch):
		...
		pool = mp.Pool()
		result = pool.map(forwording, input_x, input_y)
...
# main
learning_rate = 0.1
input_x, input_y = ip.inputer("1-2.txt")
print(input_x)
print(input_y)

mw, mu = Backpropagation(input_x, input_y, 4, 3, 1, learning_rate)
